...
export const themes: Record<ThemeId, ThemeColors> = {
  padraoEscuro: {
    ...
    indigoPanel: 'rgba(52, 211, 153, 0.14)',
    text: '#f8fafc',
    ...
    compModalBtnPrint: '#2563eb',
    compModalBtnPrintText: '#ffffff',
  ...
  escuroSistema: {
    ...
    accentMuted: '#a8c7fa',
    accentCode: '#9ec5ff',
    indigoPanel: 'rgba(138, 180, 248, 0.16)',
    text: '#ececec',
  ...
  neonVerde: {
    ...
    accentMuted: '#6dff3a',
    accentCode: '#b0ffcc',
    indigoPanel: 'rgba(57, 255, 20, 0.12)',
    text: '#f4fdf7',
    textSecondary: '#b6e6cb',
    textMuted: '#7fb89a',
    formLabel: '#c4eed8',
    inputBg: '#0b110e',
    placeholder: '#6ea389',
